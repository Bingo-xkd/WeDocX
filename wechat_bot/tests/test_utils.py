...
from wechat_bot.utils import parse_url, parse_task_id, parse_command
...
@pytest.mark.parametrize("text, expected", [
    ("task id is 123e4567-e89b-12d3-a456-426614174000", "123e4567-e89b-12d3-a456-426614174000"),
...
@pytest.mark.parametrize("text, expected_cmd, expected_args", [
    ...
    ("/status 123e4567-e89b-12d3-a456-426614174000", "status", "123e4567-e89b-12d3-a456-426614174000"),
    ("/help", "help", ""),
